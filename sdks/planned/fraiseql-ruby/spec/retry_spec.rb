...
RSpec.describe 'FraiseQL::Client retry behaviour' do
  ...
  describe 'with retry_config on non-retryable error' do
  ...
  describe 'exhausting all retry attempts' do
