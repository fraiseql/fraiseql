defmodule GenerateParitySchemaTest do
  @moduledoc """
  Generate parity schema for cross-SDK comparison.

  Usage:
    SCHEMA_OUTPUT_FILE=/tmp/schema_elixir.json mix test test/generate_parity_schema_test.exs
  """
  use ExUnit.Case

  test "generate parity schema" do
    schema = %{
      "types" => [
        %{
          "name" => "User",
    ...
    case System.get_env("SCHEMA_OUTPUT_FILE") do
      nil -> IO.puts(json)
      "" -> IO.puts(json)
