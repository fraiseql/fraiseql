...
/// <param name="Functions">Registered serverless functions (#1325), omitted when empty.</param>
public record IntermediateSchema(
    ...
    [property: JsonPropertyName("functions")]   IReadOnlyList<IntermediateFunction>? Functions = null);
