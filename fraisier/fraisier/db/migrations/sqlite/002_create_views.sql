-- SQLite Migration: Create read-side views for CQRS pattern

-- Fraise status view - read-side projection of current fraise state
...
-- Deployment history view - ordered deployment records
...
-- Webhook event history view - with deployment linking
