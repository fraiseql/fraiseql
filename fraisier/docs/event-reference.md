...
- [nats-integration-guide.md](nats-integration-guide.md) - Event bus setup
- [webhook-reference.md](webhook-reference.md) - Webhook events
- [api-reference.md](api-reference.md) - HTTP event endpoints
