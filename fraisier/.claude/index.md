...
5. **[trinity-patterns.md](trinity-patterns.md)**
...
|----------|---------|--------|
| [00-start-here.md](00-start-here.md) | Navigation & overview | 5 min |
...
| [trinity-patterns.md](trinity-patterns.md) | Database architecture | 30 min |
| [../../docs/architecture.md](../../docs/architecture.md) | System architecture | 30 min |
| [../../docs/deployment-guide.md](../../docs/deployment-guide.md) | Deployment walkthrough | 20 min |
...
3. Reference: [trinity-patterns.md](trinity-patterns.md) if database-related
...
2. Reference: [trinity-patterns.md](trinity-patterns.md) Database Inspection section
...
| ...understand the database? | See trinity-patterns.md |
| ...deploy something? | See ../../docs/deployment-guide.md |
...
- **00-start-here.md** - Navigation and overview (this is your entry point)
...
- **trinity-patterns.md** - Database architecture guide
...
- **Where should I start?** → [00-start-here.md](00-start-here.md)
...
- **How does the database work?** → [trinity-patterns.md](trinity-patterns.md)
