...
- `docs/database/table-naming-conventions.md:622-623` - Labeled "FOR PROTOTYPES ONLY" with ⚠️ WARNING
...
- `docs/development/framework-submission-guide.md` - Benchmark schema for comparing frameworks
...
1. `table-naming-conventions.md:818` - "Prefer tv_* for production, v_* for smaller apps"
