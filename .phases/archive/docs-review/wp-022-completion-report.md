...
**Documents Verified:**
- ✅ `docs/database/table-naming-conventions.md` - Primary authoritative source
...
**Key Quote from table-naming-conventions.md (Line 18-22):**
...
|----------|---------------|----------------|
| table-naming-conventions.md | `tb_`/`v_`/`tv_` for production | Lines 18-22, 599-633 |
...
- `table-naming-conventions.md:622-623` - "Simple naming without prefixes (NOT recommended for production)"
...
**Sources Verified:**
- ✅ `view-strategies.md` - Detailed comparison table
- ✅ `table-naming-conventions.md` - Performance recommendations align
...
- ✅ `mutations/cascade-architecture.md` - Technical architecture
...
- `development/framework-submission-guide.md:283-301` - **Context:** Benchmark schema (external framework comparison)
- `database/table-naming-conventions.md:622-623` - **Context:** Explicitly marked "NOT recommended for production"
...
**Locations:**
- `table-naming-conventions.md:818` - States: "Prefer `tv_*` table views for production GraphQL APIs, but `v_*` views work well for smaller applications where JOIN overhead is acceptable."
...
- ✅ `tutorials/blog-api.md` follows `database/table-naming-conventions.md`
...
1. **Consistency Maintained:** All new docs should reference `table-naming-conventions.md` as authoritative source
...
3. **Authoritative Source:** `table-naming-conventions.md` properly established as single source of truth
...
✅ **Authoritative Source Clear:** table-naming-conventions.md properly established
