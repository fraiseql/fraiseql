...
**Evidence:**
- Authoritative naming doc (`table-naming-conventions.md`) shows BOTH patterns without clear guidance
- Trinity pattern doc (`trinity-identifiers.md`) uses `products` instead of `tb_product` (wrong example)
