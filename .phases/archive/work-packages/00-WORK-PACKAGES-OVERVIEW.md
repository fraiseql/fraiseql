...
- WP-019: Create Compliance Demo Example (8h)
...
| WP-019 | Create Compliance Demo | ENG-EXAMPLES | P1 | 8 | 3 | None | ✅ DONE |
...
**Files to Update:**
- `docs/database/table-naming-conventions.md` - **CRITICAL:** Make clear recommendation for tb_/v_/tv_
- `docs/database/database-level-caching.md` - Fix `users` → `tb_user` (lines 77, 539, 644)
- `docs/database/view-strategies.md` - Ensure tv_ pattern consistency
...
**Acceptance Criteria:**
- `table-naming-conventions.md` has clear section: "Recommended Pattern: tb_/v_/tv_"
