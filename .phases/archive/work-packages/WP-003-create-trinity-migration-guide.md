...
- `docs/database/table-naming-conventions.md` (WP-002) - Authoritative naming guide
...
- [ ] Read [View Strategies](view-strategies.md) - When to use v_ vs tv_
- [ ] Read [Database Caching](database-level-caching.md) - Materialized views
