...
impl SQLComposer {
    ...
    pub fn compose(
        ...
        let mut where_builder = WhereClauseBuilder::new(self.schema.clone(), root_field.name.clone());
    ...
    fn build_order_clause(&self, _order_arg: &crate::graphql::types::GraphQLArgument) -> Result<String> {
