...
try:
    from fraiseql._fraiseql_rs import PyPermissionResolver, PyFieldAuthChecker
...
pytestmark = pytest.mark.skipif(
    not HAS_RUST_RBAC, reason="Rust RBAC extension not available"
)
...
class TestRustRBACAvailability:
    ...
    def test_rust_rbac_module_exists(self):
    ...
    def test_permission_resolver_available(self):
    ...
    def test_field_auth_checker_available(self):
...
class TestPyPermissionResolver:
    ...
    def test_resolver_cannot_create_without_pool(self):
...
class TestPyFieldAuthChecker:
    ...
    def test_field_auth_checker_cannot_create_without_resolver(self):
        """Test that field auth checker requires a resolver."""
        with pytest.raises((TypeError, RuntimeError)):
            PyFieldAuthChecker(None)

    def test_field_auth_checker_has_required_methods(self):
...
class TestRustResolverPythonWrapper:
    ...
    def test_rust_resolver_import(self):
    ...
    def test_rust_resolver_has_correct_api(self):
...
class TestRBACModels:
    ...
    def test_permission_model_structure(self):
    ...
    def test_role_model_structure(self):
...
class TestErrorHandling:
    ...
    def test_rust_not_available_error_message(self):
...
class TestDocumentation:
    ...
    def test_rust_resolver_has_docstrings(self):
    ...
    def test_performance_claims_documented(self):
