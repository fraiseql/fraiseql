...
class TestAutoGeneratedErrors:
    ...
    @pytest.mark.asyncio
    async def test_auto_generated_errors_from_status(self, schema, db):
        """
    ...
    @pytest.mark.asyncio
    async def test_auto_generated_errors_multiple_status_formats(self, schema, db):
        """
        ...
        for status, expected_id, expected_code in test_cases:
            ...
            assert result.errors is None, f"GraphQL errors for {status}: {result.errors}"
...
class TestExplicitErrors:
    ...
    @pytest.mark.asyncio
    async def test_explicit_errors_override_auto_generation(self, schema, db):
        """
...
class TestBackwardCompatibility:
    ...
    @pytest.mark.asyncio
    async def test_backward_compatibility_with_mutation_result_base(self, schema, db):
        """
