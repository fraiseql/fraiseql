...
@pytest.mark.skip(reason="WP-034 Phase 1: Native error arrays feature not yet implemented")
class TestAutoGeneratedErrors:
    """Test automatic error array generation from status strings."""

    @pytest.mark.asyncio
    async def test_auto_generated_errors_from_status(self, blog_simple_graphql_client, db):
        """
    ...
    async def test_auto_generated_errors_multiple_status_formats(
        self, blog_simple_graphql_client, db
    ):
        """
...
class TestExplicitErrors:
    ...
    @pytest.mark.asyncio
    async def test_explicit_errors_override_auto_generation(self, blog_simple_graphql_client, db):
        """
