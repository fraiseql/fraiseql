...
class TestEndToEndMACAddressFiltering:
    ...
    def test_field_name_conversion_snake_to_camel_mac(self):
        ...
        graphql_where = {
            "deviceMacAddress": {  # camelCase
                "neq": "00:11:22:33:44:55"
            }
        }
    ...
    def test_field_detection_recognizes_mac_addresses(self):
        ...
        mac_field_names = [
            "mac_address", "macAddress", "device_mac", "deviceMac",
            "mac_addr", "macAddr", "hardware_address", "hardwareAddress",
            "mac", "deviceMacAddress"
        ]

        for field_name in mac_field_names:
            field_type = detect_field_type(field_name, "00:11:22:33:44:55", None)
            assert field_type == FieldType.MAC_ADDRESS, f"Field '{field_name}' should be detected as MAC_ADDRESS"
    ...
    def test_field_detection_recognizes_mac_values(self):
        ...
        for mac_value in mac_values:
            ...
            assert field_type == FieldType.MAC_ADDRESS, f"Value '{mac_value}' should be detected as MAC_ADDRESS"
    ...
    def test_operator_function_selection_for_mac_addresses(self):
        ...
        for operator in mac_operators:
            ...
            assert "::macaddr" in sql_string, f"MAC operator {operator} should use ::macaddr casting"
