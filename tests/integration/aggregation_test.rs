...
use fraiseql_core::runtime::{AggregateQueryParser, AggregationProjector, AggregationSqlGenerator, Executor};
use fraiseql_core::schema::CompiledSchema;
use serde_json::json;
use std::sync::Arc;

// Test database URL (requires running PostgreSQL instance)
const TEST_DB_URL: &str =
    "postgresql://fraiseql_test:fraiseql_test_password@localhost:5433/test_fraiseql";

/// Helper to create test fact table metadata
...
// Integration test with real database (ignored by default)
#[tokio::test]
#[ignore]
...
// Test temporal bucketing SQL generation
#[test]
