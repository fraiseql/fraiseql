...
from fraiseql.federation.dataloader import EntityDataLoader, DataLoaderStats
...
class MockResolver:
    ...
    def resolve(self, typename, key_values):
        """Mock resolve method."""
        pass
...
class TestDataLoaderBasics:
    ...
    @pytest.mark.asyncio
    async def test_load_single_entity(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_load_missing_entity(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_load_many_same_type(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_load_many_different_types(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_load_returns_future_immediately(self, loader, clear_entities):
...
class TestDataLoaderDeduplication:
    ...
    @pytest.mark.asyncio
    async def test_duplicate_requests_share_future(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_many_duplicate_requests(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_dedup_with_mixed_requests(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_order_preserved_with_dedup(self, loader, mock_pool, clear_entities):
...
class TestDataLoaderCaching:
    ...
    @pytest.mark.asyncio
    async def test_cache_hit_on_second_load(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_cache_miss_for_different_keys(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_clear_cache_invalidates_results(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_lru_cache_size_limit(self, loader, mock_pool, clear_entities):
...
class TestDataLoaderStats:
    ...
    @pytest.mark.asyncio
    async def test_stats_tracking(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_cache_hit_rate_calculation(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_dedup_rate_calculation(self, loader, mock_pool, clear_entities):
...
class TestDataLoaderBatching:
    ...
    @pytest.mark.asyncio
    async def test_batch_window_timeout(self, mock_pool, clear_entities):
        ...
        loader = EntityDataLoader(
            MockResolver(), mock_pool, cache_size=100, batch_window_ms=5.0
        )
    ...
    @pytest.mark.asyncio
    async def test_explicit_flush(self, loader, mock_pool, clear_entities):
...
class TestDataLoaderErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_database_error_propagated(self, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_partial_batch_failure(self, clear_entities):
...
class TestDataLoaderIntegration:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_operations(self, loader, mock_pool, clear_entities):
    ...
    @pytest.mark.asyncio
    async def test_loader_close_flushes_pending(self, loader, mock_pool, clear_entities):
