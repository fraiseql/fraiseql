...
class MockAsyncPool:
    ...
    def __init__(self, data=None, query_latency_ms=0.1):
...
class TestDataLoaderPerformance:
    ...
    @pytest.mark.asyncio
    async def test_single_entity_latency(self, benchmark, clear_entities_fixture):
    ...
    @pytest.mark.benchmark
    @pytest.mark.asyncio
    async def test_batch_throughput_10_entities(self, clear_entities_fixture):
    ...
    @pytest.mark.benchmark
    @pytest.mark.asyncio
    async def test_batch_throughput_100_entities(self, clear_entities_fixture):
        ...
        # Create test data
        data = {(f"User", f"user-{i}"): {"name": f"User{i}"} for i in range(100)}
    ...
    @pytest.mark.benchmark
    @pytest.mark.asyncio
    async def test_cache_hit_performance(self, clear_entities_fixture):
    ...
    @pytest.mark.benchmark
    @pytest.mark.asyncio
    async def test_deduplication_effectiveness(self, clear_entities_fixture):
    ...
    @pytest.mark.benchmark
    @pytest.mark.asyncio
    async def test_mixed_hit_miss_performance(self, clear_entities_fixture):
        ...
        # 20 unique entities
        data = {(f"User", f"user-{i}"): {"name": f"User{i}"} for i in range(20)}
        pool = MockAsyncPool(data, query_latency_ms=1.0)
        loader = EntityDataLoader(MockResolver(), pool, batch_window_ms=10.0)
    ...
    @pytest.mark.benchmark
    @pytest.mark.asyncio
    async def test_batch_window_impact(self, clear_entities_fixture):
    ...
    @pytest.mark.benchmark
    @pytest.mark.asyncio
    async def test_sequential_vs_concurrent(self, clear_entities_fixture):
        ...
        start = time.perf_counter()
        tasks = [
            asyncio.create_task(loader_conc.load("User", "id", f"user-{i}"))
            for i in range(10)
        ]
    ...
    @pytest.mark.benchmark
    @pytest.mark.asyncio
    async def test_memory_efficiency_large_batch(self, clear_entities_fixture):
        ...
        # 1000 entities
        num_entities = 1000
        data = {(f"User", f"user-{i}"): {"name": f"User{i}"} for i in range(num_entities)}
