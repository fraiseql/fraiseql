...
from fraiseql.utils.ip_utils import is_ipv4_address, ipv4_mask_len
...
class TestIPv4MaskLength:
    ...
    @pytest.mark.parametrize("netmask,expected_length", [
    ...
    @pytest.mark.parametrize("invalid_netmask", [
