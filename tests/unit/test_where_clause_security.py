...
class TestSQLInjectionProtection:
    ...
    def test_jsonb_path_sql_injection_protection(self) -> None:
    ...
    def test_field_name_sql_injection_protection(self) -> None:
    ...
    def test_operator_value_sql_injection_protection(self) -> None:
    ...
    def test_in_operator_sql_injection_protection(self) -> None:
    ...
    def test_like_pattern_sql_injection_protection(self) -> None:
