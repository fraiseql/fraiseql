...
class TestReadinessProbe:
    ...
    def test_readiness_includes_status(self, client):
    ...
    def test_readiness_includes_duration(self, client):
...
class TestFullHealthCheck:
    ...
    def test_full_check_returns_200_or_503(self, client):
        """Full health check returns 200 or 503."""
        response = client.get("/health")
        assert response.status_code in [200, 503]

    def test_full_check_includes_status(self, client):
    ...
    def test_full_check_includes_timestamp(self, client):
        """Full check includes timestamp."""
        response = client.get("/health")
        data = response.json()
        assert "timestamp" in data

    def test_full_check_includes_all_layers(self, client):
    ...
    def test_full_check_database_has_status(self, client):
    ...
    def test_full_check_cache_has_status(self, client):
    ...
    def test_full_check_graphql_has_status(self, client):
    ...
    def test_full_check_tracing_has_status(self, client):
    ...
    def test_full_check_includes_duration(self, client):
...
class TestDatabaseHealthEndpoint:
    ...
    def test_database_endpoint_returns_200_or_503(self, client):
        """Database endpoint returns valid status code."""
        response = client.get("/health/database")
        assert response.status_code in [200, 503]

    def test_database_endpoint_includes_status(self, client):
    ...
    def test_database_endpoint_includes_message(self, client):
    ...
    def test_database_endpoint_includes_details(self, client):
    ...
    def test_database_endpoint_includes_response_time(self, client):
...
class TestCacheHealthEndpoint:
    ...
    def test_cache_endpoint_returns_200_or_503(self, client):
        """Cache endpoint returns valid status code."""
        response = client.get("/health/cache")
        assert response.status_code in [200, 503]

    def test_cache_endpoint_includes_status(self, client):
    ...
    def test_cache_endpoint_includes_message(self, client):
        """Cache endpoint includes status message."""
        response = client.get("/health/cache")
        data = response.json()
        assert "message" in data

    def test_cache_endpoint_includes_details(self, client):
...
class TestGraphQLHealthEndpoint:
    ...
    def test_graphql_endpoint_returns_200_or_503(self, client):
        """GraphQL endpoint returns valid status code."""
        response = client.get("/health/graphql")
        assert response.status_code in [200, 503]

    def test_graphql_endpoint_includes_status(self, client):
    ...
    def test_graphql_endpoint_includes_details(self, client):
...
class TestTracingHealthEndpoint:
    ...
    def test_tracing_endpoint_returns_200_or_503(self, client):
        """Tracing endpoint returns valid status code."""
        response = client.get("/health/tracing")
        assert response.status_code in [200, 503]

    def test_tracing_endpoint_includes_status(self, client):
...
class TestEndpointErrorHandling:
    ...
    def test_endpoints_dont_crash_on_monitor_unavailable(self, client):
