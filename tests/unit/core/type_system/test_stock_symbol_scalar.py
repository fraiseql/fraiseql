...
class TestStockSymbolSerialization:
    ...
    def test_serialize_valid_stock_symbols(self):
    ...
    def test_serialize_invalid_stock_symbol(self):
...
class TestStockSymbolParsing:
    ...
    def test_parse_valid_stock_symbol(self):
        """Test parsing valid stock symbols."""
        assert parse_stock_symbol_value("AAPL") == "AAPL"
        assert parse_stock_symbol_value("aapl") == "AAPL"

    def test_parse_invalid_stock_symbol(self):
...
class TestStockSymbolField:
    ...
    def test_create_valid_stock_symbol_field(self):
        """Test creating StockSymbolField with valid values."""
        symbol = StockSymbolField("AAPL")
        assert symbol == "AAPL"

    def test_create_invalid_stock_symbol_field(self):
