...
class TestDomainNameSerialization:
    ...
    def test_serialize_valid_domain_names(self):
    ...
    def test_serialize_invalid_domain_names(self):
...
class TestDomainNameParsing:
    ...
    def test_parse_valid_domain_names(self):
    ...
    def test_parse_invalid_domain_names(self):
...
class TestDomainNameField:
    ...
    def test_create_valid_domain_name_field(self):
    ...
    def test_create_invalid_domain_name_field(self):
