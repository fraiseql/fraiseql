...
class TestISINSerialization:
    ...
    def test_serialize_valid_isins(self):
    ...
    def test_serialize_invalid_isin(self):
...
class TestISINParsing:
    ...
    def test_parse_valid_isin(self):
