...
class TestContainerNumberSerialization:
    ...
    def test_serialize_valid_container_numbers(self):
    ...
    def test_serialize_invalid_container_number(self):
...
class TestContainerNumberParsing:
    ...
    def test_parse_valid_container_number(self):
    ...
    def test_parse_invalid_container_number(self):
...
class TestContainerNumberField:
    ...
    def test_create_valid_container_number_field(self):
    ...
    def test_create_invalid_container_number_field(self):
