...
class TestTrackingNumberSerialization:
    ...
    def test_serialize_valid_tracking_numbers(self):
    ...
    def test_serialize_invalid_tracking_number(self):
...
class TestTrackingNumberParsing:
    ...
    def test_parse_valid_tracking_number(self):
    ...
    def test_parse_invalid_tracking_number(self):
...
class TestTrackingNumberField:
    ...
    def test_create_valid_tracking_number_field(self):
    ...
    def test_create_invalid_tracking_number_field(self):
