...
class TestExchangeRateSerialization:
    ...
    def test_serialize_valid_exchange_rates(self):
    ...
    def test_serialize_invalid_exchange_rate(self):
...
class TestExchangeRateParsing:
    ...
    def test_parse_invalid_exchange_rate(self):
