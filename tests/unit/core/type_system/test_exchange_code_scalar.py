...
class TestExchangeCodeSerialization:
    ...
    def test_serialize_valid_exchange_codes(self):
    ...
    def test_serialize_invalid_exchange_code(self):
...
class TestExchangeCodeParsing:
    ...
    def test_parse_valid_exchange_code(self):
        """Test parsing valid exchange codes."""
        assert parse_exchange_code_value("NYSE") == "NYSE"

    def test_parse_invalid_exchange_code(self):
...
class TestExchangeCodeField:
    ...
    def test_create_valid_exchange_code_field(self):
        """Test creating ExchangeCodeField with valid values."""
        code = ExchangeCodeField("NYSE")
        assert code == "NYSE"

    def test_create_invalid_exchange_code_field(self):
