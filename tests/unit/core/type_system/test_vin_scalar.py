...
class TestVINSerialization:
    ...
    def test_serialize_valid_vins(self):
    ...
    def test_serialize_invalid_vin(self):
...
class TestVINParsing:
    ...
    def test_parse_invalid_vin(self):
...
class TestVINField:
    ...
    def test_create_valid_vin_field(self):
    ...
    def test_create_invalid_vin_field(self):
