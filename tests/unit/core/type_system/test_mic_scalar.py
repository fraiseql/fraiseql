...
class TestMICSerialization:
    ...
    def test_serialize_valid_mics(self):
    ...
    def test_serialize_invalid_mic(self):
...
class TestMICParsing:
    ...
    def test_parse_valid_mic(self):
        """Test parsing valid MICs."""
        assert parse_mic_value("XNYS") == "XNYS"

    def test_parse_invalid_mic(self):
...
class TestMICField:
    ...
    def test_create_valid_mic_field(self):
        """Test creating MICField with valid values."""
        mic = MICField("XNYS")
        assert mic == "XNYS"

    def test_create_invalid_mic_field(self):
