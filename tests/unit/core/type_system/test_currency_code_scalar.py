...
class TestCurrencyCodeSerialization:
    ...
    def test_serialize_valid_currency_codes(self):
    ...
    def test_serialize_invalid_currency_code(self):
...
class TestCurrencyCodeParsing:
    ...
    def test_parse_valid_currency_code(self):
    ...
    def test_parse_invalid_currency_code(self):
...
class TestCurrencyCodeField:
    ...
    def test_create_valid_currency_code_field(self):
    ...
    def test_create_invalid_currency_code_field(self):
