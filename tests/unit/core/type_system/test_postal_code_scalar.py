...
class TestPostalCodeSerialization:
    ...
    def test_serialize_valid_postal_codes(self):
    ...
    def test_serialize_invalid_postal_code(self):
...
class TestPostalCodeParsing:
    ...
    def test_parse_valid_postal_code(self):
    ...
    def test_parse_invalid_postal_code(self):
...
class TestPostalCodeField:
    ...
    def test_create_valid_postal_code_field(self):
    ...
    def test_create_invalid_postal_code_field(self):
