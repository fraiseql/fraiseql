...
class TestLicensePlateSerialization:
    ...
    def test_serialize_valid_license_plates(self):
    ...
    def test_serialize_invalid_license_plate(self):
...
class TestLicensePlateParsing:
    ...
    def test_parse_valid_license_plate(self):
    ...
    def test_parse_invalid_license_plate(self):
...
class TestLicensePlateField:
    ...
    def test_create_valid_license_plate_field(self):
    ...
    def test_create_invalid_license_plate_field(self):
