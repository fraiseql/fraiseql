...
class TestNumericOperatorStrategy:
    ...
    def test_supports_numeric_specific_operators_without_type(self, strategy) -> None:
    ...
    def test_supports_all_operators_with_int_type(self, strategy) -> None:
    ...
    def test_supports_all_operators_with_float_type(self, strategy) -> None:
    ...
    def test_does_not_support_non_numeric_types(self, strategy) -> None:
    ...
    def test_comparison_operators(self, strategy, path_sql) -> None:
    ...
    def test_jsonb_casting_for_integers(self, strategy, path_sql) -> None:
    ...
    def test_jsonb_casting_for_floats(self, strategy, path_sql) -> None:
