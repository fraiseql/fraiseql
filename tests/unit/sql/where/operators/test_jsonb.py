...
class TestJSONBKeyOperators:
    ...
    def test_has_any_keys(self) -> None:
    ...
    def test_has_single_key_any(self) -> None:
    ...
    def test_has_single_key_all(self) -> None:
...
class TestJSONBContainmentOperators:
    ...
    def test_contained_by_dict(self) -> None:
    ...
    def test_contained_by_list(self) -> None:
    ...
    def test_strictly_contains(self) -> None:
...
class TestJSONBPathOperators:
    ...
    def test_get_path_text(self) -> None:
    ...
    def test_get_path_text_deep(self) -> None:
...
class TestJSONBEdgeCases:
    ...
    def test_contains_nested_dict(self) -> None:
    ...
    def test_contains_with_null(self) -> None:
    ...
    def test_contains_with_numbers(self) -> None:
    ...
    def test_contains_with_boolean(self) -> None:
    ...
    def test_contains_empty_dict(self) -> None:
    ...
    def test_jsonpath_complex_expression(self) -> None:
...
class TestNullOperators:
    ...
    def test_isnull_on_simple_column(self) -> None:
    ...
    def test_isnotnull_on_simple_column(self) -> None:
    ...
    def test_isnull_on_jsonb_path(self) -> None:
