...
class TestListInOperator:
    ...
    def test_in_with_floats(self) -> None:
    ...
    def test_in_with_mixed_types(self) -> None:
...
class TestListNotInOperator:
    ...
    def test_notin_with_strings(self) -> None:
    ...
    def test_notin_with_integers(self) -> None:
    ...
    def test_notin_with_booleans(self) -> None:
...
class TestListOperatorErrors:
    ...
    def test_in_requires_list(self) -> None:
        ...
        with pytest.raises(TypeError, match="'in' operator requires a list"):
            build_in_sql(path_sql, "not-a-list")  # type: ignore[misc]
    ...
    def test_notin_requires_list(self) -> None:
        ...
        with pytest.raises(TypeError, match="'notin' operator requires a list"):
            build_notin_sql(path_sql, 42)  # type: ignore[misc]

    def test_in_with_none_list(self) -> None:
        """Test IN operator with None instead of list."""
        path_sql = SQL("field")
        with pytest.raises(TypeError, match="'in' operator requires a list"):
            build_in_sql(path_sql, None)  # type: ignore[misc]


class TestListOperatorEdgeCases:
    """Test edge cases for list operators."""

    def test_in_with_special_characters(self) -> None:
    ...
    def test_notin_with_large_numbers(self) -> None:
    ...
    def test_in_with_unicode_strings(self) -> None:
