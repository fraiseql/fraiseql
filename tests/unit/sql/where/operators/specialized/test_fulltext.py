...
class TestBasicFullTextSearch:
    ...
    def test_matches_with_operators(self) -> None:
    ...
    def test_matches_with_phrases(self) -> None:
    ...
    def test_plain_query_basic(self) -> None:
    ...
    def test_phrase_query_basic(self) -> None:
    ...
    def test_websearch_query_basic(self) -> None:
    ...
    def test_websearch_with_quotes(self) -> None:
...
class TestRelevanceRankingOperators:
    ...
    def test_rank_gt_basic(self) -> None:
    ...
    def test_rank_gt_with_complex_query(self) -> None:
    ...
    def test_rank_gte_basic(self) -> None:
    ...
    def test_rank_lt_basic(self) -> None:
    ...
    def test_rank_lte_basic(self) -> None:
...
class TestCoverDensityRankingOperators:
    ...
    def test_rank_cd_gt_basic(self) -> None:
    ...
    def test_rank_cd_gte_basic(self) -> None:
    ...
    def test_rank_cd_lt_basic(self) -> None:
    ...
    def test_rank_cd_lte_basic(self) -> None:
...
class TestFullTextEdgeCases:
    ...
    def test_matches_with_special_characters(self) -> None:
    ...
    def test_plain_query_with_numbers(self) -> None:
    ...
    def test_phrase_query_with_hyphens(self) -> None:
    ...
    def test_websearch_with_operators(self) -> None:
...
class TestRankingErrorHandling:
    ...
    def test_rank_gt_missing_colon(self) -> None:
    ...
    def test_rank_gt_invalid_threshold(self) -> None:
        """Test rank_gt with invalid threshold."""
        field_sql = SQL("document_tsv")
        with pytest.raises(ValueError, match="could not convert string to float"):
            build_rank_gt_sql(field_sql, "database:invalid")  # type: ignore[misc]

    def test_rank_gte_missing_colon(self) -> None:
    ...
    def test_rank_lt_missing_colon(self) -> None:
    ...
    def test_rank_lte_missing_colon(self) -> None:
    ...
    def test_rank_cd_gt_missing_colon(self) -> None:
    ...
    def test_rank_cd_gte_missing_colon(self) -> None:
    ...
    def test_rank_cd_lt_missing_colon(self) -> None:
    ...
    def test_rank_cd_lte_missing_colon(self) -> None:
...
class TestRankingBoundaryValues:
    ...
    def test_rank_gt_zero_threshold(self) -> None:
    ...
    def test_rank_lt_one_threshold(self) -> None:
    ...
    def test_rank_cd_gte_high_threshold(self) -> None:
    ...
    def test_rank_cd_lte_low_threshold(self) -> None:
