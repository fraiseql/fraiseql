...
class TestBasicEqualityOperators:
    ...
    def test_eq_with_strings(self) -> None:
    ...
    def test_eq_with_integers(self) -> None:
    ...
    def test_eq_with_floats(self) -> None:
    ...
    def test_eq_with_decimals(self) -> None:
    ...
    def test_eq_with_booleans(self) -> None:
    ...
    def test_eq_with_uuid(self) -> None:
    ...
    def test_eq_with_date(self) -> None:
    ...
    def test_neq_with_integers(self) -> None:
    ...
    def test_neq_with_booleans(self) -> None:
...
class TestBasicComparisonOperators:
    ...
    def test_gt_with_numbers(self) -> None:
    ...
    def test_gte_with_dates(self) -> None:
    ...
    def test_lt_with_numbers(self) -> None:
    ...
    def test_lt_with_uuid(self) -> None:
    ...
    def test_lte_with_numbers(self) -> None:
    ...
    def test_lte_with_datetime(self) -> None:
        """Test less than or equal with datetime values."""
        path_sql = SQL("data->>'expires_at'")
        dt_val = datetime(2024, 12, 31, 23, 59, 59)  # noqa: DTZ001
...
class TestBasicOperatorsEdgeCases:
    ...
    def test_eq_with_zero(self) -> None:
    ...
    def test_eq_with_negative_numbers(self) -> None:
        """Test equality with negative numbers."""
        path_sql = SQL("data->>'balance'")
        result = build_eq_sql(path_sql, -100)
        sql_str = result.as_string(None)
        assert sql_str in {"data->>'balance'::numeric = -100", "data->>'balance'::numeric =  -100"}

    def test_eq_with_large_numbers(self) -> None:
    ...
    def test_eq_with_floating_point_precision(self) -> None:
    ...
    def test_eq_with_empty_string(self) -> None:
    ...
    def test_eq_with_special_characters(self) -> None:
    ...
    def test_eq_with_unicode(self) -> None:
        """Test equality with unicode characters."""
        path_sql = SQL("data->>'title'")
        result = build_eq_sql(path_sql, "café & naïve résumé")
        sql_str = result.as_string(None)
        assert "café" in sql_str
        assert "naïve" in sql_str
        assert "résumé" in sql_str

    def test_neq_with_null_like_values(self) -> None:
    ...
    def test_comparison_with_boundary_dates(self) -> None:
