...
class TestBasicEqualityOperators:
    ...
    def test_eq_with_strings(self):
        ...
        assert "data->>'name' = 'John Doe'" == sql_str
    ...
    def test_eq_with_integers(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'age'::numeric = 25" == sql_str
    ...
    def test_eq_with_floats(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'score'::numeric = 95.5" == sql_str
    ...
    def test_eq_with_decimals(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'price'::numeric = 19.99" == sql_str
    ...
    def test_eq_with_uuid(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'user_id'::uuid = '550e8400e29b41d4a716446655440000'::uuid" == sql_str
    ...
    def test_eq_with_date(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'birth_date'::date = '1990-05-15'::date" == sql_str
    ...
    def test_eq_with_datetime(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'created_at'::timestamp = '2023-07-15 10:30:45'::timestamp" == sql_str
    ...
    def test_neq_with_strings(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'status' != 'inactive'" == sql_str
    ...
    def test_neq_with_integers(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'count'::numeric != 0" == sql_str
    ...
    def test_neq_with_booleans(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'is_deleted' != 'false'" == sql_str
...
class TestBasicComparisonOperators:
    ...
    def test_gt_with_numbers(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'age'::numeric > 18" == sql_str
    ...
    def test_gt_with_dates(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'created_at'::timestamp > '2023-01-01 00:00:00'::timestamp" == sql_str
    ...
    def test_gte_with_numbers(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'score'::numeric >= 90" == sql_str
    ...
    def test_gte_with_dates(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'updated_at'::date >= '2023-06-01'::date" == sql_str
    ...
    def test_lt_with_numbers(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'temperature'::numeric < 100" == sql_str
    ...
    def test_lt_with_uuid(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'id'::uuid < 'ffffffffffffffffffffffffffffffff'::uuid" == sql_str
    ...
    def test_lte_with_numbers(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'quantity'::numeric <= 50" == sql_str
    ...
    def test_lte_with_datetime(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'expires_at'::timestamp <= '2024-12-31 23:59:59'::timestamp" == sql_str
...
class TestBasicOperatorsEdgeCases:
    ...
    def test_eq_with_negative_numbers(self):
        ...
        sql_str = result.as_string(None)
        assert (
            "data->>'balance'::numeric = -100" == sql_str
            or "data->>'balance'::numeric =  -100" == sql_str
        )
    ...
    def test_eq_with_large_numbers(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'big_number'::numeric = 9223372036854775807" == sql_str
    ...
    def test_eq_with_floating_point_precision(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'pi'::numeric = 3.141592653589793" == sql_str
    ...
    def test_eq_with_empty_string(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'description' = ''" == sql_str
    ...
    def test_eq_with_special_characters(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'name' = 'O''Connor & Sons'" == sql_str  # SQL escaping
    ...
    def test_neq_with_null_like_values(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'optional_field' != 'null'" == sql_str
    ...
    def test_comparison_with_boundary_dates(self):
        ...
        sql_str = result.as_string(None)
        assert "data->>'date_field'::timestamp >= '1970-01-01 00:00:00'::timestamp" == sql_str

        # Far future date
        future = datetime(9999, 12, 31, 23, 59, 59)
        result = build_lt_sql(path_sql, future)
        sql_str = result.as_string(None)
        assert "data->>'date_field'::timestamp < '9999-12-31 23:59:59'::timestamp" == sql_str
