...
from fraiseql import field, fraise_type
...
class TestComplexFieldAuthorization:
    ...
    def test_nested_permission_checks(self):
        ...
        def is_owner(info, *args, **kwargs):
            return info.context.get("user", {}).get(
                "id",
            ) == info.context.get("resource_owner_id")
        ...
        class SecureResource:
            ...
            @authorize_field(
                complex_check,
                error_message="Must be authenticated and either admin or owner",
            )
    ...
    async def test_async_permission_with_database_check(self):
        ...
        info.context = {
            "user": {"id": 1},
            "db_permissions": {"1:view_financial": True},
        }
    ...
    def test_permission_with_custom_error_codes(self):
        ...
        class TieredService:
            ...
            @authorize_field(
                ...
                error_message="Premium subscription required",
            )
