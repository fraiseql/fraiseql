...
from fraiseql.security.security_headers import (
    SecurityHeadersConfig, SecurityHeadersMiddleware, ContentSecurityPolicy,
    CSPDirective, ReferrerPolicy, FrameOptions,
    create_strict_csp, create_development_csp, create_api_csp,
    create_production_security_config, create_development_security_config,
    create_graphql_security_config, setup_security_headers
)
...
class TestSecurityHeadersMiddleware:
    ...
    def test_conditional_headers(self, app):
        ...
        config = SecurityHeadersConfig(
            conditional_headers=[add_api_headers]
        )
        app.add_middleware(SecurityHeadersMiddleware, config=config)
