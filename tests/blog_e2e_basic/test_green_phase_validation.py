...
class TestGreenPhaseSummary:
    ...
    def test_all_red_phase_requirements_satisfied(self):
        ...
        requirements_met = {
            ...
            "Clean result types without inheritance": not issubclass(CreateAuthorSuccess, MutationResultBase),
            "Auto-decoration of success/failure types": hasattr(CreateAuthorSuccess, '__fraiseql_success__'),
            "Integration with DEFAULT_ERROR_CONFIG": hasattr(CreateAuthorEnhanced, '__fraiseql_error_config__'),
    ...
    def test_pattern_benefits_achieved(self):
        ...
        benefits_achieved = {
            ...
            "Auto-decoration eliminates boilerplate": hasattr(CreateAuthorSuccess, '__fraiseql_success__'),
