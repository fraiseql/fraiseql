...
class TestGenerateInsertJsonCall:
    ...
    def test_generate_basic_mutation_query(self, sample_input_type):
    ...
    def test_generate_mutation_with_context(self, sample_input_type):
    ...
    def test_generate_mutation_with_empty_input(self, sample_input_type):
    ...
    def test_generate_mutation_with_unset_fields(self):
    ...
    def test_generate_mutation_with_complex_input(self, sample_input_type):
    ...
    def test_generate_mutation_with_special_characters(self, sample_input_type):
    ...
    def test_generate_mutation_with_custom_context_keys(self, sample_input_type):
    ...
    def test_input_with_falsy_values(self, sample_input_type):
    ...
    def test_non_dataclass_input_raises_error(self):
        ...
        with pytest.raises(TypeError, match="Expected a dataclass instance"):
            generate_insert_json_call(
                input_object=NotADataclass(),
                context={},
                sql_function_name="update_user",
            )

    def test_string_values_are_stripped(self, sample_input_type):
