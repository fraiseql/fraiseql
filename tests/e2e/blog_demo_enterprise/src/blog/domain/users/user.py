...
from .value_objects import Email, FullName, Username
...
class User(AggregateRoot):
    ...
    last_login_at: str | None = field(default=None)  # ISO datetime string
    ...
    def _validate_urls(self) -> None:
        """Validate URLs."""
        urls_to_check = [("avatar_url", self.avatar_url), ("website_url", self.website_url)]
