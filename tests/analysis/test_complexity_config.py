...
class TestComplexityConfig:
    ...
    def test_custom_array_patterns(self):
        ...
        config = ComplexityConfig(
            array_field_patterns=["foolist", "barcollection", "customarray"],
        )
    ...
    def test_config_boundaries(self):
        ...
        config = ComplexityConfig(
            max_depth_penalty=999999999,
            complex_query_threshold=999999999,
        )
