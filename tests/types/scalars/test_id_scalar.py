...
class TestIDClass:
    ...
    def test_init_with_uuid_string(self):
    ...
    def test_init_with_invalid_uuid_string(self):
    ...
    def test_coerce_from_uuid(self):
    ...
    def test_equality_with_id(self):
    ...
    def test_equality_with_uuid(self):
