...
class ToxiproxyManager:
    ...
    def __init__(
        self, host: str = "localhost", port: int = 8474, mock_mode: bool | None = None
    ) -> None:
    ...
    def remove_all_toxics(self, proxy_name: str) -> None:
...
def chaos_database_latency(toxiproxy: ToxiproxyManager) -> None:
...
def chaos_packet_loss(toxiproxy: ToxiproxyManager) -> None:
...
def chaos_slow_database(toxiproxy: ToxiproxyManager) -> None:
