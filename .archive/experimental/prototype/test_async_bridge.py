...
class TestBasicQueries:
    ...
    async def test_simple_select(self, pool) -> None:
    ...
    async def test_select_with_multiple_rows(self, pool) -> None:
    ...
    async def test_select_with_multiple_columns(self, pool) -> None:
    ...
    async def test_jsonb_support(self, pool) -> None:
...
class TestConcurrentQueries:
    ...
    async def test_concurrent_simple_queries(self, pool) -> None:
    ...
    async def test_many_concurrent_queries(self, pool) -> None:
    ...
    async def test_concurrent_with_different_durations(self, pool) -> None:
...
class TestCancellation:
    ...
    async def test_query_cancellation(self, pool) -> None:
    ...
    async def test_partial_cancellation(self, pool) -> None:
...
class TestErrorHandling:
    ...
    async def test_syntax_error(self, pool) -> None:
    ...
    async def test_table_not_found(self, pool) -> None:
    ...
    async def test_type_error(self, pool) -> None:
    ...
    async def test_error_during_concurrent_execution(self, pool) -> None:
...
class TestMemoryLeaks:
    ...
    async def test_no_memory_leak_simple_queries(self, pool) -> None:
    ...
    async def test_no_memory_leak_concurrent(self, pool) -> None:
