...
class FraiseQLTracer:
    ...
    def _create_exporter(self):
        ...
        elif self.config.export_format == "jaeger":
    ...
    @contextmanager
    def trace_graphql_mutation(self, operation_name: str, query: str, variables: Optional[dict] = None):
...
def setup_tracing(app: FastAPI, config: Optional[TracingConfig] = None) -> FraiseQLTracer:
