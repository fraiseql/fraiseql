...
class MutationResultProcessor:
    ...
    def _extract_error_data(self, db_result: MutationResult, error_class: Type[T]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_success_data(self, db_result: MutationResult, success_class: Type[T]) -> Optional[Dict[str, Any]]:
