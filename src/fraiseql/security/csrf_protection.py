...
class GraphQLCSRFValidator:
    ...
    def _extract_operation_type(self, request_body: dict) -> Optional[str]:
        ...
        if query_lower.startswith("mutation"):
            ...
            return "subscription"
        elif query_lower.startswith("query") or "{" in query_lower:
            return "query"
...
class CSRFProtectionMiddleware(BaseHTTPMiddleware):
    ...
    def _validate_referrer(self, request: Request) -> Optional[JSONResponse]:
