...
class APQStorageBackend(ABC):
    ...
    def get_cached_response(
        self, hash_value: str, context: dict[str, Any] | None = None
    ) -> dict[str, Any] | None:
    ...
    def store_cached_response(
        self, hash_value: str, response: dict[str, Any], context: dict[str, Any] | None = None
    ) -> None:
    ...
    def extract_tenant_id(self, context: dict[str, Any] | None) -> str | None:
