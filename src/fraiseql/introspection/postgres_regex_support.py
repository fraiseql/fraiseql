...
class RegexPatternMatcher:
    ...
    def _validate_pattern(self) -> None:
        ...
        try:
            ...
            raise ValueError(f"Invalid regex pattern: {e!s}")
...
class PostgresIntrospectorRegexExt:
    ...
    def discover_views_by_regex(
        connection, pattern: str, schema: str = "public", case_sensitive: bool = True
    ) -> List[dict]:
...
def extend_postgres_introspector(introspector_class):
    ...
    def wrapper(*args, **kwargs):
        ...
        introspector_class.discover_views_by_regex = (
            PostgresIntrospectorRegexExt.discover_views_by_regex
        )
        introspector_class.discover_functions_by_regex = (
            PostgresIntrospectorRegexExt.discover_functions_by_regex
        )
