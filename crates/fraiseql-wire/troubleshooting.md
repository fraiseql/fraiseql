...
6. **See performance-tuning.md** for detailed optimization strategies.
...
3. **Optimize Postgres query** (see performance-tuning.md):
...
See `SECURITY.md` and `performance-tuning.md` for more detailed guidance.
