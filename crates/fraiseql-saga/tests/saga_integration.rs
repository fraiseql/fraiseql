...
mod wired_pg {
    ...
    use fraiseql_federation::{FederatedType, FederationMetadata, KeyDirective};
    use fraiseql_saga::{
        CompensationStatus, FederationMutationExecutor, MutationType, PostgresSagaStore, Saga,
        SagaCompensator, SagaExecutor, SagaState, SagaStep, StepState,
    };
    use serde_json::json;
    use uuid::Uuid;
...
mod recovery_pg {
    ...
    use fraiseql_federation::{FederatedType, FederationMetadata, KeyDirective};
    use fraiseql_saga::{
        FederationMutationExecutor, MutationType, PostgresSagaStore, RecoveryConfig, Saga,
        SagaRecoveryManager, SagaState, SagaStep, StepState,
    };
    use serde_json::json;
    use uuid::Uuid;
...
mod coordinator_pg {
    ...
    use fraiseql_federation::{FederatedType, FederationMetadata, KeyDirective};
    use fraiseql_saga::{
        CompensationStrategy, FederationMutationExecutor, PostgresSagaStore, SagaCoordinator,
...
mod remote_dispatch_pg {
    ...
    use fraiseql_federation::{FederatedType, FederationMetadata, KeyDirective};
    use fraiseql_saga::{
        CompensationStrategy, FederationMutationExecutor, HttpMutationConfig, PostgresSagaStore,
        SagaCoordinator, SagaCoordinatorStep, SagaState, StepState,
    };
    use serde_json::json;
    use uuid::Uuid;
    use wiremock::{
...
mod prefetch_pg {
    ...
    use fraiseql_db::{PostgresAdapter, traits::DatabaseAdapter};
    use fraiseql_federation::{FederatedType, FederationMetadata, HttpClientConfig, KeyDirective};
    use fraiseql_saga::{
        CompensationStrategy, FederationMutationExecutor, PostgresSagaStore, RequiredField,
        SagaCoordinator, SagaCoordinatorStep, SagaState, SagaStoreError, StepState,
    };
    use serde_json::json;
    use uuid::Uuid;
    use wiremock::{
...
mod recovery_safety_pg {
    ...
    use fraiseql_federation::{FederatedType, FederationMetadata, KeyDirective};
    use fraiseql_saga::{
        CompensationStrategy, FederationMutationExecutor, HttpMutationConfig, MutationType,
        PostgresSagaStore, RecoveryConfig, RetryPolicy, Saga, SagaCoordinator, SagaCoordinatorStep,
        SagaRecoveryManager, SagaState, SagaStep, StepState,
    };
    use serde_json::json;
    use uuid::Uuid;
    ...
    async fn store_rejects_reexecuting_a_completed_step() {
        ...
        assert!(
            matches!(err, fraiseql_saga::SagaStoreError::InvalidStateTransition { .. }),
...
mod compensation_honesty_pg {
    ...
    use fraiseql_federation::{FederatedType, FederationMetadata, KeyDirective};
    use fraiseql_saga::{
        CompensationStatus, CompensationStrategy, FederationMutationExecutor, MutationType,
        PostgresSagaStore, Saga, SagaCompensator, SagaCoordinator, SagaCoordinatorStep,
        SagaExecutor, SagaState, SagaStep, StepState,
    };
    use serde_json::json;
    use uuid::Uuid;
...
mod wired_execution_pg {
    ...
    use fraiseql_federation::{FederatedType, FederationMetadata, KeyDirective};
    use fraiseql_saga::{
        FederationMutationExecutor, MutationType, SagaExecutor, SagaStep, StepState,
    };
    use serde_json::json;
    use uuid::Uuid;
