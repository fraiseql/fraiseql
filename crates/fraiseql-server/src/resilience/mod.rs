...
//!
//! # Wiring [`crate::resilience::backpressure::AdmissionController`]
//!
//! [`crate::resilience::backpressure::AdmissionController`] is available but not yet wired into
...
//! [`crate::resilience::backpressure::AdmissionController::try_acquire`] (or
//! [`crate::resilience::backpressure::AdmissionController::acquire_timeout`]) at the top of the
