...
/// Create an Arrow Flight service with a FraiseQL Wire database adapter.
///
/// Uses the FraiseQL Wire adapter for streaming JSON queries with low memory overhead.
///
/// # Arguments
///
