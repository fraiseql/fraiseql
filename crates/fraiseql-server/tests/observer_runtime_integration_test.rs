...
#![allow(clippy::unwrap_used)] // Reason: integration test code — panics are acceptable failures
#![allow(clippy::cast_possible_truncation)] // Reason: test data values are small and bounded
#![allow(clippy::cast_sign_loss)] // Reason: test data uses positive values only
