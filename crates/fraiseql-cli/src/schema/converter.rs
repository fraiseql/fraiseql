...
use fraiseql_core::{
    schema::{
        ...
        DirectiveLocationKind, EnumDefinition, EnumValueDefinition, FieldDefinition,
        FieldDenyPolicy, FieldType,
...
impl SchemaConverter {
    ...
    pub fn convert(intermediate: IntermediateSchema) -> Result<CompiledSchema> {
        ...
        inject_relay_types(&mut compiled);
...
fn inject_relay_types(schema: &mut CompiledSchema) {
