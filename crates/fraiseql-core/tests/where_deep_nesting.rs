...
fn test_where_nested_path_3_levels() {
    ...
    let clause = WhereClause::Field {
        path: vec!["user".to_string(), "profile".to_string(), "address".to_string()],
...
fn test_where_nested_path_with_different_operators() {
    ...
    let path = vec!["a".to_string(), "b".to_string(), "c".to_string(), "d".to_string(), "e".to_string()];
    ...
    for (op, _desc) in operators {
        ...
        match clause {
            WhereClause::Field { path: p, operator, .. } => {
                assert_eq!(p.len(), 5);
...
fn test_where_nested_path_numeric_components() {
    ...
    let path = vec!["users".to_string(), "0".to_string(), "addresses".to_string(), "1".to_string(), "zip".to_string()];
...
fn test_where_deeply_nested_with_null_value() {
    ...
    let path = vec!["data".to_string(), "metadata".to_string(), "created".to_string(), "timestamp".to_string(), "timezone".to_string()];
...
fn test_where_deeply_nested_with_array_value() {
    ...
    let path = vec!["org".to_string(), "departments".to_string(), "members".to_string(), "roles".to_string(), "permissions".to_string()];
...
fn test_where_deeply_nested_case_sensitivity() {
    ...
    let path_lower = vec!["user".to_string(), "profile".to_string(), "email".to_string(), "address".to_string(), "domain".to_string()];
    let path_upper = vec!["USER".to_string(), "PROFILE".to_string(), "EMAIL".to_string(), "ADDRESS".to_string(), "DOMAIN".to_string()];
    ...
    match (clause_lower, clause_upper) {
        (
            WhereClause::Field { path: p1, .. },
            WhereClause::Field { path: p2, .. },
        ) => {
...
fn test_where_deeply_nested_with_ltree_operators() {
    ...
    let path = vec!["org".to_string(), "hierarchy".to_string(), "department".to_string(), "team".to_string(), "structure".to_string()];
...
fn test_where_deeply_nested_repeating_components() {
    ...
    let path = vec!["data".to_string(), "data".to_string(), "data".to_string(), "data".to_string(), "value".to_string()];
...
fn test_where_deeply_nested_empty_component() {
    ...
    let path = vec!["a".to_string(), "".to_string(), "b".to_string(), "".to_string(), "c".to_string()];
