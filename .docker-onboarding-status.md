...
**Project Status**: Phase 1 ✅ Complete | Phase 2-5 🔄 Planned
...
**Features**:
- 6-chapter curriculum (What is FraiseQL → Next Steps)
...
- ✅ All 4 services start and are healthy within 30 seconds
- ✅ GraphQL IDE accessible at localhost:3000
- ✅ Sample queries execute successfully
- ✅ PostgreSQL pre-populated with blog data (3 users, 4 posts)
- ✅ Tutorial server running at localhost:3001
- ✅ Clear, concise documentation
- ✅ Make targets for convenient management
...
## Phase 2: Interactive Tutorial System 🔄 Pending
...
## Phase 4: Multi-Example Support 🔄 Pending
...
│     └─ sample data (3 users, 4 posts)
│
├─ FraiseQL Server (port 8000)
│  ├─ Loads: examples/basic/schema.compiled.json
│  ├─ Endpoint: /graphql
│  └─ Health: /health
│
├─ Apollo Sandbox (port 3000)
│  └─ Browser-based GraphQL IDE
│
└─ Tutorial Server (port 3001)
