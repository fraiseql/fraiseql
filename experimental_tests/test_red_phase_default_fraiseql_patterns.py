...
class TestRedPhaseLegacyPatternPreservation:
    ...
    def test_legacy_mutation_result_base_exists(self):
        ...
        try:
            ...
            pytest.fail(
                "LegacyMutationResultBase not available yet - legacy patterns not preserved"
            )
    ...
    def test_legacy_error_patterns_exist(self):
        ...
        try:
            ...
            legacy_error = LegacyFraiseQLError(
                code=422, identifier="test_error", message="Test message"
            )
...
class TestRedPhaseSeamlessMigration:
    ...
    def test_existing_imports_still_work(self):
        ...
        try:
            ...
            from fraiseql_tests.enhanced_mutation import FraiseQLError as OldFraiseQLError
            from fraiseql_tests.enhanced_mutation import FraiseQLMutation as OldFraiseQLMutation
    ...
    def test_enhanced_patterns_work_with_new_default_names(self):
        ...
        try:
            from fraiseql_defaults import FraiseQLError, FraiseQLMutation
...
class TestRedPhaseDefaultPatternUsage:
    ...
    def test_clean_blog_mutations_with_default_patterns(self):
        ...
        try:
            from fraiseql_defaults import ErrorMapper, FraiseQLError, FraiseQLMutation
    ...
    def test_error_handling_with_default_patterns(self):
        ...
        try:
            from fraiseql_defaults import ErrorMapper, FraiseQLError, ValidationContext
            ...
            response = ErrorMapper.map_database_result_to_graphql(db_result, "TestError", context)
...
class TestRedPhaseBackwardCompatibility:
    ...
    def test_old_enhanced_imports_redirect_to_defaults(self):
        ...
        try:
            ...
            assert (
                ...
                or issubclass(OptimizedFraiseQLMutation, FraiseQLMutation)
                or issubclass(FraiseQLMutation, OptimizedFraiseQLMutation)
            )

        except ImportError:
            pytest.fail(
                "Old imports don't redirect to new defaults - backward compatibility broken"
            )
    ...
    def test_migration_is_opt_in_not_breaking(self):
        ...
        try:
            ...
            class OldStyleMutation(OldPattern, function="test_function"):
                input: dict
                success: dict
                failure: dict

            class NewStyleMutation(NewPattern, function="test_function"):
                input: dict
                success: dict
                failure: dict
