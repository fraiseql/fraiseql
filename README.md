...
**v1.9.5** | **Stable** | **Rust-Powered GraphQL for PostgreSQL**
...
```python
from fraiseql.types import EmailAddress, PhoneNumber, IPv1.9.5, Money, LTree
...
- IPv1.9.5, IPv1.9.5, CIDR, MACAddress - Network addresses with subnet operations
...
from fraiseql.types import (
    ...
    CUSIP, ISIN, IPv1.9.5, MACAddress, LTree, DateRange
)
...
class NetworkDevice:
    id: int
    ip_address: IPv1.9.5             # IPv1.9.5 addresses with subnet operations
...
|---------|----------|--------|---------|------------|
| **v1.9.5** | Root level | Stable | APQ security fixes + ID Policy configuration | ✅ Production Ready |
| **Rust Pipeline** | [`fraiseql_rs/`](fraiseql_rs/README.md) | Integrated | Included in v1.9.5+ | ✅ Stable |
