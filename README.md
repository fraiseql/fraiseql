...
**v1.9.13** | **Stable** | **Rust-Powered GraphQL for PostgreSQL**
...
| **Field Filtering (Mutations)** | ✅ | ✅ | ✅ | ✅ Production ready | Full implementation (v1.9.13+) |
...
**Roadmap:**
- **v1.9.13**: Complete security profile enforcement (Issue #225)
- **v1.9.13**: Add RBAC enforcement verification tests
- **v1.9.13**: Unified field filtering for all query types
- **v1.9.13**: Full security audit and penetration testing

> **Important**: This matrix reflects current implementation status (v1.9.13). Security features are under active development. Always verify features meet your requirements before production deployment. See [Issue #225](https://github.com/fraiseql/fraiseql/issues/225) for implementation progress.
...
|---------|----------|--------|---------|------------|
| **v1.9.13** | Root level | Stable | Entity field selection for mutations (GitHub #525) | ✅ Production Ready |
| **Rust Pipeline** | [`fraiseql_rs/`](fraiseql_rs/README.md) | Integrated | Included in v1.9.13+ | ✅ Stable |
