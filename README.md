...
**📍 You are here: Main FraiseQL Framework (v1.7.1) - Production Stable**

**Current Version**: v1.7.1 | **Status**: Production Stable | **Python**: 3.13+ | **PostgreSQL**: 13+
...
|---------|----------|--------|---------|------------|
| **v1.7.1** | Root level | Production Stable | Latest stable release | ✅ Recommended |
| **Rust Pipeline** | [`fraiseql_rs/`](fraiseql_rs/) | Integrated | Included in v1.0+ | ✅ Stable |
| **v1.7.0** | Superseded | Legacy | Use v1.7.1 | ⚠️ Upgrade |
