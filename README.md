...
**📍 You are here: Main FraiseQL Framework (v1.8.4) - Stable Release**

**Current Version**: v1.8.4 | **Status**: Stable | **Python**: 3.13+ | **PostgreSQL**: 13+
...
- IPv1.8.4, IPv1.8.4, CIDR, MACAddress - Network addresses with subnet operations
...
from fraiseql.types import (
    ...
    CUSIP, ISIN, IPv1.8.4, MACAddress, LTree, DateRange
)
...
class NetworkDevice:
    id: int
    ip_address: IPv1.8.4             # IPv1.8.4 addresses with subnet operations
...
|---------|----------|--------|---------|------------|
| **v1.8.4-beta.5** | Root level | Beta | Security hardening + documentation improvements | ✅ Production Ready |
| **Rust Pipeline** | [`fraiseql_rs/`](fraiseql_rs/) | Integrated | Included in v1.8.4+ | ✅ Stable |
| **v1.8.4** | Superseded | Legacy | Use v1.8.4-beta.5 or wait for v1.8.4 stable | ⚠️ Upgrade |
