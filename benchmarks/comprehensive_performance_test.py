...
class PerformanceBenchmark:
            ...
            if user_count < 1000 * scale_factor:
                ...
                for i in range(20000 * scale_factor):
                    ...
                    comments_data.append((
                        f"Comment {i}: " + "This is a comment. " * 10,
                        post_id,
                        author_id
                    ))
                ...
                # Insert tags
                tags = ['technology', 'programming', 'python', 'javascript', 'database',
    ...
    def generate_report(self):
        ...
        for scenario_name, results in scenarios.items():
            ...
            # Create table
            print(f"{'DB Size':<10} {'Users':<10} {'RPS':<10} {'Avg (ms)':<10} {'P95 (ms)':<10} {'P99 (ms)':<10} {'Errors':<10} {'Memory':<10}")
            print("-" * 80)
        ...
        if self.results:
            ...
            print(f"   Config: {best_rps.concurrent_users} users, {best_rps.database_size_gb:.1f}GB DB")
            
            print(f"\n❌ Worst throughput: {worst_rps.requests_per_second:.1f} RPS")
            print(f"   Scenario: {worst_rps.scenario}")
            print(f"   Config: {worst_rps.concurrent_users} users, {worst_rps.database_size_gb:.1f}GB DB")
