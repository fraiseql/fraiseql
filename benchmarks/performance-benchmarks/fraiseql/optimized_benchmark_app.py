...
from fraiseql.fastapi.turbo_router import TurboGraphQLRouter
from fraiseql.turbo import TurboConfig, QueryRegistrar, TurboExecutor
...
async def register_common_queries():
    ...
    try:
        ...
        await registrar.register_query(
            ...
            view_name="tv_products"
        )
        
        await registrar.register_query(
            "orders_100",
            "SELECT data FROM tv_orders LIMIT $1", 
            view_name="tv_orders"
        )
