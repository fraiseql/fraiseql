...
from schema import (
    ...
    ProductFilterInput, OrderFilterInput, PaginationInput, OrderByInput,
    create_user_loader, create_category_loader, create_product_loader
)
...
query_histogram = Histogram('graphql_query_duration_seconds', 'GraphQL query duration', ['operation', 'type'])
