...
class TestTenantContentIsolation:
    ...
    async def test_posts_isolated_by_tenant(self, enterprise_gql_client, multi_tenant_content_data):
        ...
        result1 = await enterprise_gql_client.execute(
            query,
        ...
        result2 = await enterprise_gql_client.execute(
            query,
    ...
    @pytest.mark.asyncio
    async def test_comments_isolated_by_tenant(self, enterprise_gql_client, multi_tenant_content_data):
...
def multi_tenant_content_data(enterprise_gql_client):
    ...
    posts_data = {
        "org1_post_id": str(uuid.uuid4()),
        "org2_post_id": str(uuid.uuid4())
    }
