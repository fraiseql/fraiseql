...
from .value_objects import Content, PostStatus, Slug, Title
...
class Post(AggregateRoot):
    ...
    published_at: str | None = field(default=None)  # ISO datetime string
    ...
    def can_be_published(self) -> bool:
        ...
        return (
            self.title.value.strip() and self.content.value.strip() and not self.status.is_deleted()
        )
    ...
    def update_featured_image(self, image_url: str | None) -> None:
